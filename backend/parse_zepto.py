#!/usr/bin/env python3
"""
Zepto Response Parser CLI
Parses Zepto API responses and displays normalized products
"""
import sys
import os
...
from providers.zepto import ZeptoProvider, load_response_from_file
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        # Default to sample_responses/zeptoResponse.json
