#!/usr/bin/env python3
"""
Instamart Response Parser CLI
Parses Instamart API responses and displays normalized products
"""
import sys
import os
...
from providers.instamart import InstamartProvider, load_response_from_file
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        # Default to sample_responses/instamartResponse.json
        response_file = os.path.join(
            backend_dir, 
            "sample_responses", 
            "instamartResponse.json"
        )
